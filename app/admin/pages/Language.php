...
<div class="container-fluid pt-5 w-100">
    ...
    <div class="boca-tabs py-3">
        <div class="div-tabs d-flex gap-3" id="">
            <a href="/wp-admin/admin.php?page=boca_submenu_Language" data-target="main" data-active="true" class="tab-btn active">Language</a>
            <a href="/wp-admin/admin.php?page=boca_submenu_Language&translate-language=true" data-target="translate" data-active="false" class="tab-btn">Translate</a>
            <a href="/wp-admin/admin.php?page=boca_submenu_Language&translate-domain=true" data-target="translate" data-active="false" class="tab-btn">Domain</a>
        </div>
    </div>
